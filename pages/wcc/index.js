...
export default function WCC() {
    return (
        <div className={styles.wcc}>
            ...
            <p>
                Every December, the Minnesota Computer Club hosts a programming competition for all
                middle and high school students.
                <br />
                <br />
                There are 25 puzzles, given out at midnight EST once per day from December 1st -
                25th. Our competition ends on December 31st, so there is some extra time to get as
                many puzzles done as possible. At midnight on December 31st, the scores will be
                calculated. Our competition is only based on the number of problems completed (stars
                acquired), not the speed/score unless there is a tie at the end.
            </p>
            ...
            <p>
                ...
                <br />
                <br />
                You may not share your solutions with anyone outside of your group. Again, it is up
                to the honor of the individual to maintain the integrity of the tournament.
                <br />
                <br />
            ...
            <p>
                ...
                <a href="https://forms.gle/1hFTUsLNribKy9fm6">this google form</a> and then fill out
                the form on{' '}
                <a href="https://sites.google.com/isd535.org/cs-pathways/contests">this page</a> if
                you are a student. <i>(required)</i>
                <br />
                <br />
                Want to chat with other participants? Want to find a team? You will need to go to
                join the Minnesota Computer Club discord server. Email{' '}
