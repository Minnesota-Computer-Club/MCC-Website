    ...
    return (
        <>
            ...
            <main className="p-10 text-gray-400">
                <h2 className="text-4xl py-4 text-white text-center">RCC Winter Coding Competition</h2>
                ...
                <div className="text-center p-4">
                    <div className="inline-flex items-center justify-center rounded-md border border-transparent bg-darkpurple px-5 py-3 text-base font-medium text-white hover:bg-white hover:text-darkpurple hover:cursor-pointer">
                        <Link href="/rochester/wcc/leaderboard">View Leaderboard</Link>
                    </div>
                </div>

                <p className="pb-4">Every December, the Rochester Computer Club hosts a programming competition for all middle and high school students.</p>
                ...
                <p className="pb-8">To participate, please use your Google Account to <a href="https://adventofcode.com/2022/auth/login" target="__blank" className="font-bold text-medpurple hover:underline cursor-pointer">log into the AOC website</a> and then fill out <a href="https://forms.gle/4g9MYAjyY4KmnvEo9" target="__blank" className="font-bold text-medpurple hover:underline cursor-pointer">this google form</a>. <i>(required)</i></p>
